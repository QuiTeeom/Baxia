...
public class Baxia {
    ...
    public static void scan(String scanPattern) {
        new BxScaner(aClass -> {
            if (aClass.getAnnotation(com.quitee.baxia.core.annotations.Space.class) != null){
                spaceGroup.createSpace(aClass, (com.quitee.baxia.core.annotations.Space) aClass.getAnnotation(com.quitee.baxia.core.annotations.Space.class));
            }
